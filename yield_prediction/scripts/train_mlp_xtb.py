...
策略：保留原有MLP架构（已验证有效），直接添加xTB特征作为额外输入
"""
import sys
import json
import argparse
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default=str(project_root / 'checkpoints' / 'mlp_xtb'))
    ...
    # 训练
    print("\n" + "=" * 70)
    print("开始训练 MLP+xTB (目标: 超越 MLP MAE 12.75%)")
    print("=" * 70)
